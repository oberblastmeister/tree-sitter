...
pub struct QueryMatches<'a, 'tree: 'a, 't, T: TextProvider<'t>> {
    ptr: *mut ffi::TSQueryCursor,
    query: &'a Query,
    text_provider: T,
    buffer1: Vec<u8>,
    buffer2: Vec<u8>,
    _tree: PhantomData<(&'tree (), &'t ())>,
}
...
impl QueryCursor {
    ...
    pub fn matches<'a, 'tree: 'a, 't, T: TextProvider<'t>>(
        &'a mut self,
        query: &'a Query,
        node: Node<'tree>,
        text_provider: T,
    ) -> QueryMatches<'a, 'tree, 't, T> {
...
impl<'a, 'tree, 't, T: TextProvider<'t>> Iterator for QueryMatches<'a, 'tree, 't, T> {
...
impl<'a, 'tree, 't, T: TextProvider<'t>> QueryMatches<'a, 'tree, 't, T> {
    #[doc(alias = "ts_query_cursor_set_byte_range")]
